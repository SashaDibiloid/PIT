...
{
    /// <summary>
    /// Логика взаимодействия для Admin_report.xaml
    /// </summary>
    public partial class Admin_report : System.Windows.Controls.Page
    {
        public Admin_report()
        {
            InitializeComponent();
            DGrid_Clients.ItemsSource = PITEntities.GetContext().Product.ToList();
        }
        ...
        private void Button_Click_Word(object sender, RoutedEventArgs e)
        {
            ...
            para.Range.Text = "Отчет о товарах";
        ...
        private void Button_Click_Excel(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                worksheet.Cells[1, 1] = "Отчет о товарах";
            }
