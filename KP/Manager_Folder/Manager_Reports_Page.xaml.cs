...
{
    /// <summary>
    /// Логика взаимодействия для Manager_Reports_Page.xaml
    /// </summary>
    public partial class Manager_Reports_Page : System.Windows.Controls.Page
    {
        public Manager_Reports_Page()
        {
            InitializeComponent();
            DGrid_Clients.ItemsSource = PITEntities.GetContext().Client.ToList();
        }
